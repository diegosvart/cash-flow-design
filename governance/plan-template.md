...
|-----------|------|----------------------|---------|
| [nombre] | [doc/design/code/test] | [criterio verificable] | [URL o ruta] |
...
- [ ] Los planes anteriores están marcados como `archived`.
...
- **GitHub**: https://github.com/diegosvart/cash-flow-design
